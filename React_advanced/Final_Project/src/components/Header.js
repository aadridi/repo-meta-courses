...
const Header = () => {
	...
	return (
		<Box position='fixed' top={0} left={0} right={0} zIndex={1000} transform={transform} transitionProperty='transform' transitionDuration='.3s' transitionTimingFunction='ease-in-out' backgroundColor='#18181b'>
